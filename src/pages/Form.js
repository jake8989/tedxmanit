            ...
            <Box display="flex" alignItems="center" flexDirection="column">
                <Box padding="2rem" width={'80%'}>
                    ...
                    <Typography fontSize={'1.2rem'} textAlign={'justify'}>
                        TEDxMANITBhopal is back after a decade, and this time, we are bringing together some of the most inspiring and innovative minds from across the country to share their Maverick's Chronicles with you. We invite you to come and be a part of this incredible experience.
                    </Typography>

                    <br />
                    <Typography fontSize={'1.2rem'} textAlign={'justify'}>
                        Prepare to be blown away by the incredible stories of our TEDxMANITBhopal speakers who have defied the odds, shattered conventions, and forged their own paths to greatness  and inspire you to think outside the box and push your own boundaries.
                        So gear up for an unforgettable experience at TEDxMANITBhopal and witness the power of the Maverick's Chronicles.
                    </Typography>
                    <br />
                    ...
                    <br />
                    <Typography fontSize={'1.2rem'} textAlign={'center'}>
                        <b>Early Bird Ticket Price: </b>Rs. 499  {`( Only for Non-Manitians )`}
                    </Typography>
                    <br />
                    <Typography fontSize={'1.2rem'} textAlign={'center'}>
                    ...
                    <br />
                    <Typography fontSize={'1.2rem'} textAlign={'center'}>
                        Check out our Instagram Page to know more about our speakers: <Link to='https://www.instagram.com/tedxmanitbhopal/?igshid=YmMyMTA2M2Y%3D'
                            ...
                            <List>
                                ...
                                <ListItem sx={{ display: 'flex', flexDirection: 'column' }}>
                                    ...
                                    {sub && (
                                        ...
                                        >
                                            Form Submmited Succesfully <Link to="/"> Click to continue</Link>
                                        </Alert>
                                    )}
